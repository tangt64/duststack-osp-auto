...
network --device=eth0 --hostname=node4.example.com --bootproto=static --ip=192.168.122.140 --netmask=255.255.255.0 --gateway=192.168.122.1 --nameserver=8.8.8.8
network --device=ens2f0 --hostname=node4.example.com --bootproto=static --ip=192.168.90.140 --netmask=255.255.255.0
